# FORENSIX Error Codes & Troubleshooting

## Error Codes

| Code | Description | Solution |
|------|-------------|----------|
| E001 | Root privileges required | Run with: sudo forensix |
...
| E008 | Database locked | Close other FORENSIX instances |
...
### Permission Denied
- FORENSIX requires root privileges
...
- Documentation: https://github.com/raffelsfuxk/FORENSIX/wiki
