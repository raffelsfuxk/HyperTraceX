...
def create_parser():
    ...
    acquire_parser.add_argument("--ext", default="", help="File extensions")
    ...
    carve_parser.add_argument("--types", default="", help="File types")
    ...
    browser_parser.add_argument("--browsers", default="chrome,firefox,edge", help="Browsers")
