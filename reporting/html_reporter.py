#!/usr/bin/env python3
"""HyperTraceX HTML Reporter - Generate professional HTML forensic reports."""
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p class="subtitle">HyperTraceX Platform | Generated: {case.get('generated_at', datetime.now().isoformat())}</p>
        </div>
        <div class="content">
        ...
        <div class="footer">
            <p>Generated by HyperTraceX v1.0.0 | Author: raffelsfuxk</p>
