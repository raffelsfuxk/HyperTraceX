#!/usr/bin/env python3
"""FORENSIX PDF Reporter - Generate professional PDF forensic reports."""
...
class PDFReporter:
    ...
    def _add_cover_page(self, pdf: FPDF):
        ...
        pdf.cell(0, 10, "FORENSIX Platform v1.0.0", align="C", new_x="LMARGIN", new_y="NEXT")
    ...
    def _add_signature_block(self, pdf: FPDF):
        ...
        pdf.cell(0, 6, "Generated by FORENSIX v1.0.0 - Enterprise Digital Forensics Platform", align="C", new_x="LMARGIN", new_y="NEXT")
